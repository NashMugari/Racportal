            ...
            <div class="col-md-8">
                ...
                <h5>Welcome! you are chatting with <span class="chatwith mg-text"></span></h5>
                 ...
                 :key="message.id">
                  	  ...
                  	  <p>{{message.message}}<br><span style='font-size: 10px; color:rgb(0, 195, 255);' class="message pt-1"><i>{{message.startdate}}</i></span></p>
                    ...
                    <input v-model="chat.description"
                        @keyup.enter="sendMessage" type="text" id="description" class="mt-3 mr-2 pl-2 pr-2" style="border:1px solid #666666"/>
                         <br> <br>
...
export default {
  ...
  methods: {
    ...
    fetchMessages() {
      ...
      sendMessage(){
          this.chat.description = $("#description").val();
          let obj = JSON.parse(this.isLoggedIn);
          this.chat.user1 = obj.id;
          this.chat.user2 = $("#user2").val();

         //  alert(this.chat.user1);
          if(!this.chat.user2){
      ...
      //return false;
  		...
  		getRegions(){
           ...
           notifyUser(){
              ...
              swal({
                  //title: "Please Type your Mobile Number",
                  text: "You have a new private chat message !",
                  icon: "success",
                  buttons: true,
                  dangerMode: true,
              })
 ...
 let executed = false;
    Echo.private('chat')
            .listen('PrivateMessageSentEvent', (e) => {
                // this.messages.push({
                //     message: e.message.message,
                //     user: e.user
                // });
