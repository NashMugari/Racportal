                   ...
                   <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" align='center'>
                            <div class="col-md-3">
                            Rac Daily Visitors
                            <br><div class='dailyVisitor'></div>
                            </div>
                            <div class="col-md-3">
                               Rac Total Visitors
                                <br><div class='totalVisitor'></div>
                            </div>

                             <div class="col-md-3">
                              Rac Daily login
                                <br><div class='dailyLogin'></div>
                            </div>


                             <div class="col-md-3">
                               Rac Total login
                                <br><div class='totalLogin'></div>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods: {
            getContacts(){
                ...
                getDailyVisitors(){
                this.errors = [];
                axios.get('api/get-dailyVisitors')
                    .then(res => {
                       this.dailyVisitor = res.data;
                       $('.dailyVisitor').append(this.dailyVisitor);
                    }).catch(err =>{
                    this.errors = err;
                })
            },
                ...
                getTotalVisitors(){
                this.errors = [];
                axios.get('api/get-totalVisitors')
                    .then(res => {
                       this.totalVisitor = res.data;
                       $('.totalVisitor').append(this.totalVisitor);
                    }).catch(err =>{
                    this.errors = err;
                })
            },
              ...
              getDailyLogins(){
                this.errors = [];
                axios.get('api/get-dailyLogins')
                    .then(res => {
                       this.dailyLogin = res.data;
                       $('.dailyLogin').append(this.dailyLogin);
                    }).catch(err =>{
                    this.errors = err;
                })
            },
                ...
                getTotalLogins(){
                this.errors = [];
                axios.get('api/get-totalLogins')
                    .then(res => {
                       this.totalLogin = res.data;
                       $('.totalLogin').append(this.totalLogin);
                    }).catch(err =>{
                    this.errors = err;
                })
            },
