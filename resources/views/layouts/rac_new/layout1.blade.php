      ...
      <div class="row">
        <div class="col-md-3 clearfix">
          <div class="item-holder">
            <h5 class="uppercase footer-title less-mar3">RAC Calendar 2020</h5>
            <div class="footer-title-bottomstrip"></div>
            <div class="clearfix"></div>
            <div class="image-left"><a href="{{asset('rac_new/planner/2020_Final_Year_Planner.pdf')}}" target="_blank"><img src="{{asset('rac_new/planner/RAC.jpg')}}" alt="" class="img-responsive"/></a></div>         
            <div class="text-box">
              <h5 class="text-white less-mar3"><a href="{{asset('rac_new/planner/2020_Final_Year_Planner.pdf')}}" target="_blank">View Full Calendar</a></h5>
            </div>
          </div>
        </div>
        <!--end item-->
      ...
      <div class="row">
        <div class="col-md-4 "> 
          <ul class="payment-type pull-left">
            <li style="color:#ffffff" align="center"> Copyright 2020 © <a href="https://www.mwpf.co.za" style="color: #ffffff"><strong>MWPF</strong></a> &nbsp; | &nbsp; All rights reserved </li>
          </ul>		
		</div>	  
		<div class="col-md-4 ">
           <ul class="payment-type pull-left" >
		...
		<div class="col-md-4 ">
		  <ul class=" social-icons-3 pull-center">
			  ...
			  <li><a href="https://www.linkedin.com/in/mineworkers-provident-fund-68386414a/" target="_blank"><i class="fa fa-linkedin"></i></a></li>
			  <li><a href="https://www.youtube.com/watch?v=zeZ5zw3T_z8/" target="_blank"><i class="fa fa-youtube-play"></i></a></li>
