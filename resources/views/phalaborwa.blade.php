        ...
        <div class="matter">
            <div class="container-fluid">
                ...
                <div class="page-title">
                    <h2>Phalaborwa<span>Regional Advisory Committee</span></h2>
                </div>
                <!-- Title ends -->
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span5">
                            <div class="posts">
                                ...
                                <div class="entry">
                                    ...
                                    <!-- Thumbnail -->
                                    <div class="bthumb">
                                        <a href="#"><img src="img/blog9.jpg" alt="" /></a>
                                    </div>

                                    <!-- Para -->
                                    <h6 align="justify" style="color:black">The Participating Employers in the Phalaborwa Region justifies the vastness of the Mineworkers Provident Fund. Company representatives and member representatives make up the Board of Trustees Structure.
                                        <br><br>
                                        The Advisory Committee in the Phalaborwa Region of South Africa also serves as communication tool towards members on all the new developments within the Fund.</h6>
                        ...
                        <div class="span4">
                            ...
                            <div class="blog-sidebar">
                                ...
                                <div class="widget">
                                    <h4>About Phalaborwa Mining Region</h4>
                                    <p align="justify">The Advisory Committee in the Phalaborwa Region of South Africa also serves as communication tool towards members on all the new developments within the Fund. <a href="#">Phalaborwa  Region</a> </p>
                                </div>
                            </div>
                        </div>
