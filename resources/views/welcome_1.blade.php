...
@section('content')
  ...
  <div class="master-slider ms-skin-default" id="masterslider"> 
    ...
    <!-- <div class="ms-slide slide-3" data-delay="9">
      ...
      <h3 class="ms-layer text31"
			style="top: 320px; left:230px; text-shadow: 2px 2px 4px #000;font-weight:600"
			data-type="text"
			data-delay="500"
			data-ease="easeOutExpo"
			data-duration="1230"
			data-effect="right(250)">NEW DEFAULT</h3>
            
      <h3 class="ms-layer text32"
			style="top: 390px; left:230px;"
			data-type="text"
			data-delay="1000"
			data-ease="easeOutExpo"
			data-duration="1230"
			data-effect="right(250)"><span style=" text-shadow: 2px 2px 4px #000;font-weight:800"> Regulations</span></h3>
            
        
      <a    href="https://www.mwpf.co.za/downloads/defaultregulations.pdf" class="ms-layer sbut5"
			style="left: 230px; top: 480px;"
			data-type="text"
			data-delay="2000"
			data-ease="easeOutExpo"
			data-duration="1200"
